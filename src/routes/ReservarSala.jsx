...
const ReservarSala = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (data && horario_inicial && horario_final) {
      ...
      await axiosURL.post('/salagrupo', 
      { idSala, nome, qtd_pessoas, turma, motivo, data, horario_inicial, horario_final })
        ...
        <div className="grid place-items-center mx-2 sm:my-auto">
          ...
          <div className="w-11/12 p-12 sm:w-8/12 md:w-6/12 lg:w-5/12 2xl:w-4/12 
            ...
            {/*<form className="mt-10" method="POST"> */}
              ...
              {/* <!-- ID Input --> */}
              <label htmlFor="idSala" className="block capitalize font-semibold text-[1rem]/[1.5rem] lg:text-lg after:content-['*'] after:ml-0.5 after:text-red-500">ID Sala</label>
              <input type="number" name="idSala" min="1" max="2" placeholder="ID da Sala" onChange={(e) => setIdSala(e.target.value)} className="block w-full py-3 px-1 mt-2 mb-6
              ...
              {/* <!-- Quant. de Pessoas Input --> */}
              <label htmlFor="qtd_pessoas" className="block capitalize font-semibold text-[1rem]/[1.5rem] lg:text-lg after:content-['*'] after:ml-0.5 after:text-red-500">Quant. de Pessoas</label>
              <input type="number" name="qtd_pessoas" min="1" max="10" placeholder="Quantidade de Pessoas" onChange={(e) => setQtd_pessoas(e.target.value)} className="block w-full py-3 px-1 mt-2 mb-6 
                            text-gray-800 appearance-none 
                            border-b-2 border-gray-100
                            focus:text-gray-500 focus:outline-none focus:border-gray-200"
              required 
              ...
              {/* <!-- motivo Input --> */}
              <label htmlFor="motivo" className="block capitalize font-semibold text-[1rem]/[1.5rem] lg:text-lg after:content-['*'] after:ml-0.5 after:text-red-500">Motivo</label>
              <input type="text" name="motivo" placeholder="Motivo" onChange={(e) => setMotivo(e.target.value)} className="block w-full py-3 px-1 mt-2 mb-6 
                          text-gray-800 appearance-none 
                          border-b-2 border-gray-100
                          focus:text-gray-500 focus:outline-none focus:border-gray-200"
              required 
